...
import { 
  ...
  LayoutDashboard, ArrowLeft, LogOut, Search, ChevronRight,
...
const AdminPage = () => {
  ...
  const [activeTab, setActiveTab] = useState<"dashboard" | "players" | "news" | "settings">("dashboard");
              ...
              <div className="bg-card rounded-xl p-5 border border-border shadow-sm">
                <div className="flex items-center gap-3 mb-2">
                  <div className="p-2 bg-trojan-gold/10 rounded-lg">
                    <User className="text-trojan-gold-dark" size={20} />
                  </div>
